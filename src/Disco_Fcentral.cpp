...
const double Cd = 0.47; // Coeficiente de arrastre (esfer a)
const double rho = 1.225; // Densidad del aire (kg/m^3)
const double S = 1.0; // Constante de Magnus
// const double KT = 4.0; //? Connsidero que KT es una constante global pero prefiero dejarlo como puso JD
...
void Cuerpo::CalculateFuerzas(void)
{
    ...
    // Fuerza central (resorte) //TODO: Revisar otros tipos de fuerzas centrales

    vector3D Fc = -K * r; // F = -k * d * u_r = -k * d * (r_vec / d) = -k * r_vec
